...
class RelationFinder {
	...
	public $endpointURI = "http://dbpedia.org/sparql";
...
//		"skos" => "http://www.w3.org/2004/02/skos/core#"
	...
	private function completeQuery($coreQuery, $options, $vars) {
		...
		$completeQuery .= "CONSTRUCT { $coreQuery } "; //RATHACHAI
		//$completeQuery .= "FROM <http://rc.lodac.nii.ac.jp/txi/graph>  " ; //RATHACHAI
		$completeQuery .= "WHERE { "; //RATHACHI
